...
class EsBarChartSample1 extends StatefulWidget {
  const EsBarChartSample1({Key? key,});

  @override
  State<StatefulWidget> createState() => EsBarChartSample1State();
}

class EsBarChartSample1State extends State<EsBarChartSample1> {
