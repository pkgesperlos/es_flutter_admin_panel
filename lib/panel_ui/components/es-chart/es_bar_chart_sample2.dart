...
class EsBarChartSample2 extends StatefulWidget {
  const EsBarChartSample2({Key? key,});

  @override
  State<StatefulWidget> createState() => EsBarChartSample2State();
}

class EsBarChartSample2State extends State<EsBarChartSample2> {
