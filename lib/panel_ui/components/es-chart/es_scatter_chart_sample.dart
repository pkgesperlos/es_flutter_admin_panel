...
class EsScatterChartSample extends StatefulWidget {
  const EsScatterChartSample({Key? key});

  @override
  State<StatefulWidget> createState() => _EsScatterChartSampleState();
}

class _EsScatterChartSampleState extends State {
  int touchedIndex = -1;
