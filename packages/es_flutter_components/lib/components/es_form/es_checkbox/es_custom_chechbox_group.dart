      ...
      child: Column(
        ...
        children: [
          widget.isScrollable ?? true
              ? Container(
            height: 100,
            padding: EdgeInsets.symmetric(vertical:StructureBuilder.dims!.h1BorderRadius),
  ...
  List<Widget> content(){
    return List.generate(
        widget.titleList.length,
          ...
          child: Padding(
              padding: EdgeInsets.symmetric(horizontal:StructureBuilder.dims!.h1BorderRadius),
            child: Row(
              children: [
