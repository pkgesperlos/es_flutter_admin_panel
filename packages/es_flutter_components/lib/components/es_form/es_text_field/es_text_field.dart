...
class _EsSpecificTextField extends State<EsTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    //     widget.maxLines==null? StructureBuilder.dims!.h0Padding*2
    //         : widget.maxLines!*StructureBuilder.dims!.h0Padding);

    Size? _size2=widget.textFieldSize;
...
onTap: widget.onTap,
          ...
          style: widget.textStyle?? TextStyle(color: StructureBuilder.styles!.primaryDarkColor,
              fontSize: StructureBuilder.dims!.h2FontSize),
          onEditingComplete: widget.onEditingComplete,
          focusNode: widget.focusNode,
          obscureText: widget.isObscure ?? false,
          cursorColor: StructureBuilder.styles!.primaryDarkColor,
    ...
    if (_isObscure) {
      return InputDecoration(
          ...
          labelStyle: widget.labelStyle ?? TextStyle(fontSize: Dims.h2FontSize,
              color: widget.disabled??false? StructureBuilder.styles!.secondaryColor
