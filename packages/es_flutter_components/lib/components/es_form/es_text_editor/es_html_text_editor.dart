...
//This editor work by html renderer
class HtmlTextEditor extends StatefulWidget {

  HtmlTextEditor({Key? key, required this.title}) : super(key: key);
      ...
      child: Container(
        ...
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            ...
            child: EsOrdinaryText(r'<\>',color:StructureBuilder.styles!.primaryLightColor ,),
          ),
