...
class EsBlockButton extends StatefulWidget {
  String? text = "";
  VoidCallback? onTap;
  Widget? icon;
  Color? textColor ;
  ...
  State<StatefulWidget> createState() {
    ...
    return new EsBlockButtonState();
  }
}

class EsBlockButtonState extends State<EsBlockButton> {
    ...
    return Container(
      ...
      child: Material(
        ...
        child: IgnorePointer(
          ...
          child: InkWell(
            hoverColor: widget.disable?Colors.transparent:widget.hoverColor??StructureBuilder.styles!.decorationColor().buttonHover,
            onTap: onTap,
            child: Row(
              children: [
                Expanded(
  ...
  @override
  void didUpdateWidget(covariant EsBlockButton oldWidget) {
