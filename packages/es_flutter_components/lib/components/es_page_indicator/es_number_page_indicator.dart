...
int _index=(controller.page != null ? controller.page!.round() % totalPage : 0);
 return Row(
  ...
  Widget _nextJumpIndicator( bool rtl) {
    ...
    Color _normalColor = normalColor ?? StructureBuilder.styles!.primaryDarkColor;
    Color _fillColor = fillColor ?? StructureBuilder.styles!.primaryLightColor;
    Color _textColor = textColor ?? StructureBuilder.styles!.primaryDarkColor;
            ...
            child: new Container(
                ...
                child: Center(
                  child: EsSvgIcon(
                   ...
                   rtl? "packages/es_flutter_components/assets/svgs/CaretRight.svg"
        ...
        child: new Center(
          child: new Material(
            child: new Container(
                ...
                child: Center(
                  child: EsSvgIcon(
                   rtl? "packages/es_flutter_components/assets/svgs/CaretLeft.svg":
  ...
  Widget _simpleBuildIndicator(int index,) {
    ...
    Color _selectedColor =
        selectedColor ?? StructureBuilder.styles!.specificColor;
    Color _fillColor = fillColor ?? StructureBuilder.styles!.primaryLightColor;
