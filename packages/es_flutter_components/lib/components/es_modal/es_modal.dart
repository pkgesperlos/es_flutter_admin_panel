    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      showModalBottomSheet(
        isDismissible: barrierDismissible??true,
          ...
          builder: (builder) {
          double _contentHeight=contentHeight??StructureBuilder.dims!.h0Padding * 10;
          double _titleHeight=titleHeight??StructureBuilder.dims!.h0Padding * 5;
            return new Container(

              constraints: BoxConstraints(
                  maxHeight:
                  _contentHeight+_titleHeight
              ),
                            ...
                            child: Container(
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    EsOrdinaryText(
                                      StructureBuilder.configs!.lorm+StructureBuilder.configs!.lorm,
                                      align: TextAlign.justify,
                                    ),
                                    EsVSpacer(big: true,)
                                  ],
