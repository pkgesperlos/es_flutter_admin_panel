      ...
      body: _isSuccess
          ? Container(
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: StructureBuilder.styles!.primaryDarkColor, width: 1)),
              child: getBody())
          : getProgressView(),
    );
  }
                      ...
                      Padding(
                        ...
                        child: InkWell(
                            ...
                            child: data.isSelected
                                ? widget.favoriteIcon ??
                                    EsSvgIcon(
                                      "packages/es_flutter_components/assets/svgs/folderfavorite.svg",
                                      size: StructureBuilder.dims!.h3IconSize,
                                    )
                                : widget.indicatorIcon ??
                                    EsSvgIcon(
                                      "packages/es_flutter_components/assets/svgs/folder.svg",
                                      size: StructureBuilder.dims!.h3IconSize,
                                    )),
                      ),
                      EsOrdinaryText(
              ...
              Visibility(
                ...
                child: InkWell(
                    ...
                    child: widget.addIcon ??
                        EsSvgIcon(
                          "packages/es_flutter_components/assets/svgs/add.svg",
                          size: StructureBuilder.dims!.h3IconSize,
                        )),
              )
            ],
