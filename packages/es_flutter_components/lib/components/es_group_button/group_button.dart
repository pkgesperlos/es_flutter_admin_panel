...
import 'package:es_flutter_components/components/es_group_button/options/group_button_options.dart';
  ...
  Widget build(BuildContext context) {
    return GroupButton(
      ...
      options:GroupButtonOptions(
          spacing: 0,
          unselectedColor:widget.unSelectedColor?? StructureBuilder.styles!.primaryDarkColor,
